import { processCsMatchEvents } from '../inserts/csMatchEventsCopy.js';
...
async function runAllCsMatchEvents() {
  console.log("🚀 Starting to process match events for all sports...");
  ...
  for (const sport of sports) {
    ...
    try {
      await processCsMatchEvents(sport);
      executedCount++;
...
runAllCsMatchEvents().catch((error) => {
