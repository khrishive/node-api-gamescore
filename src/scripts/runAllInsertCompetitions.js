...
async function runAllInsertCompetitions() {
  console.log("🚀 Starting to insert competitions for all sports...");
...
`);
  ...
  console.log("🎉 End of runAllInsertCompetitions script.");
}

runAllInsertCompetitions().catch((error) => {
